...
?>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Sell Here</span>
                </nav>
            </div>
        </div>
    </div>
   ...
   <form action="product_db.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">SELL ON WEBSITE</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Product Name</label>
                            <input class="form-control" type="text" placeholder="Enter Product Name" name="productname" maxlength="255" required>
                        </div>
                       ...
                       <!--div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Enter Product Image" name="productimage"  maxlength="255" required>
                        </div-->
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" type="number" min="0" placeholder="Enter Product Price" name="productprice" step="any" required>
                        </div>
                        
                        <div class="col-md-6 form-group">
                            <label>Product Description</label>
                            <textarea class="form-control" name="productdescription"  placeholder="Enter Product Description" maxlength="1020" rows="5" cols="50" required></textarea>
                        </div>

                        <div class="col-md-6 form-group">
                            <label>Company Name</label>
                            <input class="form-control" type="text" placeholder="Enter Company Name" name="companyname" maxlength="255" required>
                        </div>

                        
                        <div class="col-md-12">
                            
                         <button class="btn btn-block btn-primary font-weight-bold py-3" type="submit" >Sell on Website</button>
