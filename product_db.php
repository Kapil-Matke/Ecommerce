    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">SELL ON WEBSITE - ALERT</span></h5>             
                    <div class="row">
...
// if everything is ok, try to upload file
  $message = $message . "Sorry, your file was not uploaded.File already exists with this name .Try another filename";
} else {
...
$query="INSERT INTO product(productname,productcategoryid,productdescription,productprice,productimage,companyname)VALUES('$productname','$productcategoryid','$productdescription',$productprice,'$productimage','$companyname')";

  //echo $query;

$insert = mysqli_query($conn, "INSERT INTO product(productname,productcategoryid,productdescription,productprice,productimage,companyname)VALUES('$productname','$productcategoryid','$productdescription',$productprice,'$productimage','$companyname')")or die($conn->error);
//echo"Product sell Successfully..";

 $message = $message . "Product sell Successfully..";
