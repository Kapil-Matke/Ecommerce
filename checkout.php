    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="fname" type="text" placeholder="Enter Your Name" required>
                        </div>
                        <div class="col-md-6 form-group">
                        ...
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input class="form-control" name="email"  type="text" placeholder="my@email.com" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input class="form-control" name="mono" type="text" placeholder="Enter Your 10 digit Phone No" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address 1</label>
                            <input class="form-control" name="addr" type="text" placeholder="Address 1" required>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address 2</label>
                            <input class="form-control"  name="addr2"type="text" placeholder="Address 2">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Country</label>
                        ...
                        <div class="col-md-6 form-group">
                            <label>Pincode </label>
                            <input class="form-control" name="pincode" type="text" placeholder="Enter Your 6 digit Pincode" required>
                        </div>
                ...
                <div class="mb-5" style="width:460px">
                    <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Payment</span></h5>
                    <div class="bg-light p-30">
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="directcheck" value="UPI_Payment" required>
                                <label class="custom-control-label" for="directcheck">UPI Payment</label>
                            </div>
                        </div>
                
                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="banktransfer" value="Through_QR_Payment"  required>
                                <label class="custom-control-label" for="banktransfer">Through QR Code </label>
                            </div>
                        </div>

                        <div class="form-group mb-4">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="cash" value="Cash_on_Delivery"  required>
                                <label class="custom-control-label" for="cash">Cash On Delivery </label>
                            </div>
                        </div>
                        <button class="btn btn-block btn-primary font-weight-bold py-3" name="order" >Place Order</button>
                    </div>
                </div>
            </div>
        </div>
