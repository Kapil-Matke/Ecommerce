...
?>
                    ...
                    while($result=mysqli_fetch_assoc($data1))
                        {
                            ...
                            $allTotal=$allTotal+$result['total'];
                        ?>
                    <tr>
                             <td class="align-middle"><a href="productdetails.php?productid=<?php echo $result['pid'];?>"><img src="img/<?php echo $result['productImage']; ?>" alt="ImageError" style="width: 50px;"></a></td>
                             <td><?php echo $result['productName'];?></td>
                             <td class="align-middle" id="price">Rs <?php echo $result['price']; ?> </td>
                
                            <td class="align-middle">
                            <div class="input-group quantity mx-auto" style="width: 120px;">
                    <input type="text" class="form-control form-control-sm bg-secondary border-0 text-center" 
                    value="<?php echo $result['quantity'];?>" disabled> 
                                </div>
                            </td>                                   
                           <td class="align-middle itotal" id="total"> Rs <?php echo $result['total']; ?></td>
                               <td class="align-middle"><a href="deleteCart.php?orderid=<?php echo $result['orderId']; ?>"><button class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td></a>
                         </tr>
                         <?php
                        }
  ...
  <strong>Sorry!</strong> No Products in your cart..
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
  </button>
</div>";
            ...
            <div class="col-lg-4">
                ...
                <div class="bg-light p-30 mb-5">
                    <div class="border-bottom pb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            <h6 class="font-weight-medium">Shipping</h6>
                              ...
                              {
                              ?>
                            <h6 class="font-weight-medium">Free Delivery</h6>
                           <?php 
                              }
                              else if($allTotal==0)
                              {
                    ...
                    <div class="pt-2">
                        ...
                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3"><a href="checkout.php?productid=" style="color:black">Proceed To Checkout</a></button>
                        </form> 
