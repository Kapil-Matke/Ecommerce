...
?>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">OrderDetails</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            ...
            $query1="SELECT * FROM `productorder` WHERE userId = '$userId'";
                $data1=mysqli_query($conn,$query1);
                    ...
                    while($result1=mysqli_fetch_assoc($data1))
                        ...
                        ?>
                      <tr>
                           <td class="align-middle"><?php echo $result1['orderid']; ?></td>
                            <td class="align-middle"><a href="productdetails.php?productid=<?php echo $result1['pid']; ?>"><img src="img/<?php echo $result1['productImage']; ?>" alt="" style="width: 50px;"> </td>
                            <td class="align-middle"><?php echo $result1['productName']; ?></td>
                            <td class="align-middle"><?php echo $result1['price']; ?></td>
                            <td class="align-middle"><?php echo $result1['quantity']; ?></td>
                            <td class="align-middle"><?php echo $result1['total']; ?></td>
                            <td class="align-middle" style="color:green">Ordered</td>
                            <td class="align-middle" style="color:green"><?php echo $date?></td>
                        <td class="align-middle"><a href="CancelOrder.php?orderid=<?php echo $result1['orderid']; ?>"><button class="btn btn-sm btn-danger"><i class="fa fa-times"></i></button></td></a>
  ...
  <button type='button' class='close' data-dismiss='alert' aria-label='Close'>
    <span aria-hidden='true'>&times;</span>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="pt-2">
                       <button class="btn btn-block btn-primary font-weight-bold my-3 py-3"><a href="index.php" style="color:green">Return To Home</a></button>
                    </div>

                    <div class="pt-2">
                       <button class="btn btn-block btn-primary font-weight-bold my-3 py-3"><a href="clearHistory.php" style="color:green">Clear History</a></button>
                    </div>
                </div>
            </div>
        </div>
