...
?>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <div class="mission"><h2>Our Vision</h2>
                    <h6>"To be World's most customer-centric company, where customers can find and discover anything they might want to buy online"</h6>
                    </div>
                    <div class="intro"><p>Welcome to GET BRANDS!
...
<br>
We always keep an eye on the latest trends in fashion and put our customer’s wishes first. That is why we have satisfied customer's all over the world, and are thrilled to be a part of the E-Commerce industry.
The interests of our customers are always top priority for us, so we hope you will enjoy our products as much as we enjoy making them available to you.</p><br>
                    </div>
                </nav>

<div class="row">
<div class="column">
    <div class="card" id="md">
      <!-- <img src="img2.jpg" alt="Mike" style="width:100%"> -->
      <div class="container">
        <h2>Darshan Kalyankar</h2>
        <p class="title">CEO & Founder</p>
        <p>Darshan leads the operations at Get Brands.</p>
        <p><a href="darshankalyankar333@example.com" class="button">Contact</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2>Pallavi Game</h2>
        <p class="title">MD &amp; Founder</p>
        <p>Pallavi is MD & Co-founder of Get Brands</p>
  ...
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <h2>Kapil Matke</h2>
        <p class="title">Sales & Marketing Expert</p>
        <p>Kapil is Sales & Marketing Expert of Get Brands</p>
        <p><a class="button" href="mkmatke@gmail.com">Contact</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card" id="">
      ...
      <div class="container">
        <h2>Tejaswini Dange</h2>
        <p class="title">Designer</p>
        <p>Tejaswini is an aspiring designer of Get Brands</p>
        <p><a class="button" href="">Contact</a></p>
      </div>
    </div>
  </div>
